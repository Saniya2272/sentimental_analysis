...
try:
    if VIDEO_URL:
        with st.spinner('Crunching numbers...'):
            ...
            data_sentiments = sentiments['Sentiment_Type'].value_counts(
                ...
                "series": [
                    {
                        ...
                        "data": [
                            # NEUTRAL
                            {"value": parsed['data'][1][2], "name": parsed['data'][1][0], "itemStyle": {"color": "#8F8E9E"}},
                            # POSITIVE
                            {"value": parsed['data'][0][2], "name": parsed['data'][0][0], "itemStyle": {"color": "#7AFFE7"}},
                            # NEGATIVE
                            {"value": parsed['data'][2][2], "name": parsed['data'][2][0], "itemStyle": {"color": "#FF8D8D"}}
